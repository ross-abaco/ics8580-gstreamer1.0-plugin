...
static void
videotestsrc_setup_paintinfo (GstVideoTestSink * v, paintinfo * p, int w, int h)
{
  gint a, r, g, b;
  gint width;
...
videotestsrc_convert_tmpline (paintinfo * p, GstVideoFrame * frame, int j)
{
  ...
  g_print ("gst_video_test_src_unicolor 1.width=%d\n", width);
  ...
  g_print ("gst_video_test_src_unicolor 2 n_lines=%d offset=%d.\n",n_lines,offset);
  ...
  g_print ("gst_video_test_src_unicolor 3.\n");
}
...
static void
videotestsrc_blend_line (GstVideoTestSink * v, guint8 * dest, guint8 * src,
...
void
gst_video_test_src_smpte (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int y1, y2;
  int j;
...
void
gst_video_test_src_smpte75 (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int j;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_video_test_src_smpte100 (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int j;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_video_test_src_bar (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int j;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
void
gst_video_test_src_snow (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int j;
  paintinfo pi = PAINT_INFO_INIT;
...
static void
gst_video_test_src_unicolor (GstVideoTestSink * v, GstVideoFrame * frame,
    int color_index)
{
  int i;
  paintinfo pi = PAINT_INFO_INIT;
  ...
  g_print ("gst_video_test_src_unicolor %d.\n", h);
  for (i = 0; i < h; i++) {
...
void
gst_video_test_src_black (GstVideoTestSink * v, GstVideoFrame * frame)
{
  gst_video_test_src_unicolor (v, frame, COLOR_BLACK);
}

void
gst_video_test_src_white (GstVideoTestSink * v, GstVideoFrame * frame)
{
  gst_video_test_src_unicolor (v, frame, COLOR_WHITE);
}

void
gst_video_test_src_red (GstVideoTestSink * v, GstVideoFrame * frame)
{
  gst_video_test_src_unicolor (v, frame, COLOR_RED);
}

void
gst_video_test_src_green (GstVideoTestSink * v, GstVideoFrame * frame)
{
  gst_video_test_src_unicolor (v, frame, COLOR_GREEN);
}

void
gst_video_test_src_blue (GstVideoTestSink * v, GstVideoFrame * frame)
{
  gst_video_test_src_unicolor (v, frame, COLOR_BLUE);
}

void
gst_video_test_src_blink (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
void
gst_video_test_src_solid (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
void
gst_video_test_src_checkers1 (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
void
gst_video_test_src_checkers2 (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
void
gst_video_test_src_checkers4 (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
void
gst_video_test_src_checkers8 (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
void
gst_video_test_src_zoneplate (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int j;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_video_test_src_chromazoneplate (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int j;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_video_test_src_circular (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int j;
  paintinfo pi = PAINT_INFO_INIT;
...
void
gst_video_test_src_gamut (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int x, y;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
void
gst_video_test_src_ball (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  paintinfo pi = PAINT_INFO_INIT;
  paintinfo *p = &pi;
...
paint_tmpline_AYUV (paintinfo * p, int x, int w)
{
  ...
  memset(p->tmpline + offset, value, w);
//  video_test_src_orc_splat_u32 (p->tmpline + offset, value, w);
}
...
void
gst_video_test_src_pinwheel (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int j;
  int k;
...
void
gst_video_test_src_spokes (GstVideoTestSink * v, GstVideoFrame * frame)
{
  int i;
  int j;
  int k;
